...
class Country(Field):
    ...
    def __init__(self, value=''):
        while True:
            country_404 = ['russia', 'russsia', 'rusiia', 'rusiiia', 'rossiya', 'rossiia', 'rossiya', 'rasiya', 'rossiya', 'rosija', 'rusia', 'rwsia', 'rwsiya', 'росія', 'росіія', 'россия', 'россиия', 'росиия', 'росия', 'россія', 'руссія', 'русія']
            if value:
                self.value = value
            else:
                self.value = input(f'{RESET}{BLUE}Громадянство (країна): {RESET}{YELLOW}')
            ...
            try:
                ...
                print(f'{RESET}{RED}На щастя, такої країни не існує або вона вже на межі колапсу.\nВаш контакт не буде додано, спробуйте іншу країну для продовження.{RESET}{YELLOW}')
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                print(f'{RESET}{RED}Будь ласка введіть email в правильному форматі.{RESET}{YELLOW}')
...
class Tag(Field):
    ...
    def __init__(self, value=''):
        while True:
            ...
            # За потреби можна додати додаткову перевірку
            if self.value:
                break
            else:
                print(f'{RESET}{RED}Будь ласка, введіть значення тегу.{RESET}{YELLOW}')
