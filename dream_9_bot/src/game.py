...
class GuessNumberGame:
    ...
    def play(self):
        print(f"{RESET}{BLUE}Я загадав число від 1 до 100. Спробуйте його вгадати.{RESET}{YELLOW}")
        while True:
            self.attempts += 1
            ...
            if user_guess.isdigit():
                ...
                if user_guess < self.number_to_guess:
                    ...
                    print(f"{RESET}{BLUE}Вітаю! Ви вгадали число за {self.attempts} спроб.{RESET}{YELLOW}")
                    break
            else:
